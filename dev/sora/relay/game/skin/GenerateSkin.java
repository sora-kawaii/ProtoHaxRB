...
public final class GenerateSkin {
    ...
    private final Lazy skinData$delegate = LazyKt.lazy(skinData.2.INSTANCE);
    ...
    public final SerializedSkin generateSkin(SerializedSkin object) {
        ...
        String string2 = ((SerializedSkin)object).getSkinId();
        String string3 = ((SerializedSkin)object).getPlayFabId();
        ImageData imageData = this.getSkinData();
        List list = CollectionsKt.emptyList();
        ImageData imageData2 = ImageData.EMPTY;
        String string4 = ((SerializedSkin)object).getFullSkinId();
        List list2 = CollectionsKt.emptyList();
        object = CollectionsKt.emptyList();
        object = SerializedSkin.of(string2, string3, SKIN_RESOURCE_PATCH, imageData, list, imageData2, SKIN_GEOMETRY_DATA, "0.0.0", "", false, true, false, false, "", string4, "wide", "#0", list2, (List<PersonaPieceTintData>)object);
