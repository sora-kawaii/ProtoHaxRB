...
@Metadata(d1={"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\u0018\u00002\u00020\u0001B\u0005\u00a2\u0006\u0002\u0010\u0002J\b\u0010\u000e\u001a\u00020\u000fH\u0002J\u0010\u0010\u0010\u001a\u00020\u000f2\u0006\u0010\u0011\u001a\u00020\u0012H\u0007R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004\u00a2\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082\u0004\u00a2\u0006\u0002\n\u0000R\u0014\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\b0\u0007X\u0082\u0004\u00a2\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u0082\u0004\u00a2\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\nX\u0082\u0004\u00a2\u0006\u0002\n\u0000R\u000e\u0010\f\u001a\u00020\rX\u0082\u0004\u00a2\u0006\u0002\n\u0000\u00a8\u0006\u0013"}, d2={"Ldev/sora/relay/cheat/module/impl/action/Breaker;", "Ldev/sora/relay/cheat/module/CheatModule;", "()V", "actionValue", "Ldev/sora/relay/cheat/value/ListValue;", "blockValue", "blocksList", "", "Lcom/nukkitx/math/vector/Vector3i;", "delayValue", "Ldev/sora/relay/cheat/value/FloatValue;", "rangeValue", "timer", "Ldev/sora/relay/utils/TimerUtil;", "getBlocks", "", "onTick", "event", "Ldev/sora/relay/game/event/impl/EventTick;", "ProtoHax"}, k=1, mv={1, 7, 1}, xi=48)
public final class Breaker
extends CheatModule {
    private final ListValue actionValue;
    private final ListValue blockValue;
    private final List<Vector3i> blocksList;
    ...
    private final void getBlocks() {
        ...
        Vector3i vector3i = Vector3i.from((int)entityPlayerSP.getPosX(), (int)entityPlayerSP.getPosY(), (int)entityPlayerSP.getPosZ());
        Intrinsics.checkNotNullExpressionValue((Object)vector3i, (String)"from(thePlayer.posX.toIn\u2026),thePlayer.posZ.toInt())");
        float f = ((Number)this.rangeValue.get()).floatValue();
        int n = (int)f;
        int n2 = vector3i.getX();
        for (int i = vector3i.getX() - n; i < n2 + n; ++i) {
            int n3 = vector3i.getY();
